...
var snowStorm = (function(window, document) {
  ...
  this.className = 60;          // CSS class name for further customization on snow elements
  this.excludeMobile = true;      // Snow is likely to be bad news for mobile phones' CPUs (and batteries.) By default, be nice.
  this.flakeBottom = 625;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
